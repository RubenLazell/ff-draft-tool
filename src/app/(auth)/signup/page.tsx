  ...
  return (
    <div className="flex flex-1 items-center justify-center bg-zinc-50 px-4 dark:bg-black">
      <div className="w-full max-w-sm rounded-lg border border-black/[.08] bg-white p-8 dark:border-white/[.145] dark:bg-zinc-950">
        ...
        <ul className="mb-6 flex flex-col gap-1 text-sm text-zinc-600 dark:text-zinc-400">
          <li>• Your rankings are saved permanently and sync across devices</li>
          <li>• Use the Chrome Live Draft Assistant on draft day</li>
          <li>• Print draft cheatsheets from your board</li>
        </ul>
