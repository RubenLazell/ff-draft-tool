...
// src/lib/sync/playersCore.mjs, shared with the Vercel Cron route that
// runs this automatically (src/app/api/cron/sync-data/route.ts).

import { createClient } from "@supabase/supabase-js";
import { syncPlayers } from "../src/lib/sync/playersCore.mjs";
...
syncPlayers(supabase, console.log)
